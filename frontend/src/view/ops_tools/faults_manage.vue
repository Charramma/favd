  ...
  <div>
    <Card>
      ...
      <div class="search-con search-con-top">
        ...
        <Input clearable placeholder="输入关键字搜索" class="search-input" v-model="searchValue" style="width: 200px;" />
        ...
        <Modal v-model="addFaultModal" :mask-closable="false" title="新建故障信息: " width="550px"
          ...
          <Form :model="addFaultForm" :label-width="80" ref="addFaultForm" :rules="addFaultFormRule">
            ...
            <FormItem label="开始时间" prop="startTime">
              <DatePicker type="datetime" placeholder="选择故障开始日期和时间" style="width: 400px"
                v-model="addFaultForm.startTime" format="yyyy-MM-dd HH:mm:ss">
              </DatePicker>
            </FormItem>
            <FormItem label="结束时间" prop="endTime">
              <DatePicker type="datetime" placeholder="选择故障处理完成日期和时间" style="width: 400px"
                v-model="addFaultForm.endTime" format="yyyy-MM-dd HH:mm:ss">
              </DatePicker>
            </FormItem>
