    ...
    def test_createuser(self):
        ...
        test_data = [
            ...
            {"status_code": Success.status_code,
             "data": {'email': 'mm@a.com', 'password': '5623341wrwwer', 'username': 'cali'}},
            {"status_code": FormValidateException.status_code,
             "data": {'email': 'mm@a.com', 'password': '5623341wrwwer', 'username': 'cali'}},
            {"status_code": FormValidateException.status_code,
             "data": {'email': 'bb@a.com', 'password': '1234', 'username': 'cali'}},
            {"status_code": Success.status_code,
             "data": {'email': 'cc@a.com', 'password': '1234abdsaf', 'username': "nono"}},
            {"status_code": Success.status_code,
             "data": {'email': 'dd@a.com', 'password': '1234562sdf3', 'username': '这个昵称可以'}},
        ]
        # 开始测试
